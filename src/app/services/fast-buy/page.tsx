          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="text-sm text-[#7A7A7A] font-light mb-12 space-y-1">
                <p>✓ Квартира в залоге или ипотеке — решим вопросы с банком</p>
                <p>✓ Альтернативная сделка (съезд / разъезд) — проведем безопасно</p>
                <p>✓ Полное юридическое ведение в Росреестре, задаток и аванс</p>
              </div>
