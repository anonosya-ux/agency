      ...
      <section className="pt-32 pb-24 px-4 bg-[#1A1A1A] text-white min-h-[90vh] flex flex-col">
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center">
          ...
          <div className="max-w-3xl">
            <span className="text-xs uppercase tracking-[0.2em] text-[#C5A059] block mb-4 flex items-center gap-2">
              <Clock className="w-4 h-4" /> Быстрая сделка за счет собственных средств
            </span>
            <h1 className="font-serif text-5xl lg:text-7xl leading-[1.1] mb-8">
              Срочный выкуп <br/>до 90% от рынка.
            </h1>
            <p className="text-lg text-white/60 font-light mb-12 max-w-xl leading-relaxed">
            ...
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block bg-[#C5A059] text-white px-10 py-5 uppercase tracking-widest text-xs font-semibold hover:bg-white hover:text-[#1A1A1A] transition-all duration-500"
            >
