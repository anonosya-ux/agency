          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 font-light mb-6 max-w-lg leading-relaxed">
                Персонально подберём премиальную квартиру в престижных районах Москвы (Хамовники, Пресня, Арбат, Замоскворечье). Закрытые базы застройщиков, юридическая чистота сделки.
              </p>
