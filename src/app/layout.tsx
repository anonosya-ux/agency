...
export const metadata: Metadata = {
  ...
  title: "Фатюхин и Ко | Купить, продать, обменять квартиру в Москве",
  description: "Агентство недвижимости в Москве. Купля, продажа, обмен квартир от 10 до 50 млн ₽. Срочный выкуп, альтернативные сделки, помощь с ипотекой. Бесплатная консультация.",
  ...
  openGraph: {
    title: "Фатюхин и Ко | Купля, продажа, обмен квартир в Москве",
    description: "Решим ваш квартирный вопрос за 14 дней. Квартиры бизнес и премиум-класса от 10 до 50 млн ₽.",
