...
export const properties: Property[] = [
  ...
  },
  {
    ...
    description: 'Оздоровительный комплекс на Пхукете. Фокус на здоровье и релакс.',
    features: ['SPA', 'Health Clinic', 'Тропический сад'],
    tags: ['Таиланд', 'Wellness', 'Пхукет'],
