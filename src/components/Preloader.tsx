    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-dark text-text"
        >
          <div className="flex flex-col items-center gap-8">
            <span className="text-xs uppercase tracking-[0.4em] font-light text-accent">
              Фатюхин и Ко
            </span>
