...
export default function BasicLegalPage({ title }: { title: string }) {
  return (
    <main className="min-h-screen bg-white">
      <section className="pt-40 pb-32 px-4 bg-light-gray">
        <div className="max-w-4xl mx-auto">
          <Link href="/" className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-accent hover:text-black transition-colors mb-12 font-bold">
            <ArrowLeft className="w-4 h-4" /> На главную
          </Link>
          <h1 className="font-serif text-3xl md:text-5xl leading-[1.1] mb-8 text-dark">{title}</h1>
