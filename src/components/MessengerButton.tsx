    ...
    <div className="fixed bottom-6 right-6 z-[80] flex flex-col items-end gap-3">
      ...
      {open && (
        <div className="flex flex-col gap-2 mb-2 animate-in slide-in-from-bottom-4 fade-in duration-200">
          <a
            href="https://wa.me/79951138937"
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all text-sm font-medium"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 bg-[#0088cc] text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all text-sm font-medium"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 bg-[#111111] text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all text-sm font-medium"
          >
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
          open ? 'bg-[#1A1A1A] text-white rotate-90' : 'bg-accent text-white'
        }`}
