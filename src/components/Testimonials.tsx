      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-dark leading-[1.1] max-w-xl">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={() => { pause(); prev(); }}
              className="w-12 h-12 border border-dark flex items-center justify-center hover:bg-dark hover:text-text transition-colors"
        ...
        <div className="relative min-h-[340px] md:min-h-[260px]">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Quote */}
              <p className="text-dark/80 font-light text-lg md:text-xl leading-relaxed max-w-4xl">
              ...
              <div className="mt-auto flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 pt-6 border-t border-gray-100">
                <div>
                  <p className="font-serif text-xl text-dark">{reviews[current].name}</p>
