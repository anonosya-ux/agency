...
export function TrustBanner() {
  const features = [
    {
      icon: <Landmark className="w-5 h-5 text-dark" />,
    ...
    {
      icon: <Scale className="w-5 h-5 text-dark" />,
    ...
    {
      icon: <Lock className="w-5 h-5 text-dark" />,
    ...
    {
      icon: <CheckCircle2 className="w-5 h-5 text-dark" />,
    ...
    <section className="py-24 px-4 bg-white border-y border-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-dark max-w-2xl leading-[1.1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
          {features.map((feature, idx) => (
            <div key={idx} className="flex flex-col gap-4 group">
              ...
              <h3 className="text-xl font-medium text-dark">{feature.title}</h3>
