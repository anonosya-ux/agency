      ...
      {isVisible && (
        ...
        >
          <a
            ...
            className="group flex items-center gap-0 bg-[#1A1A1A] text-white rounded-full shadow-2xl hover:shadow-[#C5A059]/20 transition-all duration-300 overflow-hidden"
          >
            <div className="w-14 h-14 flex items-center justify-center bg-[#C5A059] text-white group-hover:bg-white group-hover:text-[#1A1A1A] transition-colors shrink-0">
